...
class LinkButton(ft.Container):
    def __init__(self, link_text: str | None = None, link_addr: str | None = None, icon: str | None = None, *args, **kwargs):
        super().__init__(*args, **kwargs)
        button = ft.TextButton(icon=icon, text=link_text, on_click=lambda _: self.page.launch_url(link_addr))
        self.content = button
