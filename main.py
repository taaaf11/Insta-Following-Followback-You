...
def main(page: ft.Page):
    ...
    def navigate_to_page(e):
        ...
        if selected_page == 0:
            ...
            page.appbar.actions = [
                ft.IconButton(
                    icon=ft.icons.ADD_SHARP, on_click=lambda _: help_view.inc_size()
                ),
                ft.IconButton(
                    icon=ft.icons.REMOVE_SHARP, on_click=lambda _: help_view.dec_size()
                ),
            ]
    ...
    about_view = AboutPage(
        author_name="Muhammad Altaaf",
        author_avatar_url=f"{GITHUB_PROFILE}.png?size=120px",
